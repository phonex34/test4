...
1. Once this template project opens, select your `test4` project in the 
   Xcode *Project Navigator* panel.

2. Select the `test4` target.

3. Select the *Build Phases* tab of the `test4` target.
...
`test4Scene.m` file. To add your own 3D content, edit that method.

The `test4Scene.m` file is also where you add interactive behaviour,
